            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2"><?php echo $this->lang->line('text_leaderboard'); ?></h1>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <form name="frmleaderboardlist" method="post" action="<?php echo base_url() . $this->path_to_view_admin ?>leaderboard">
                                    ...
                                    <table id="manage_tbl" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('text_total_referral'); ?></th>
                                            </tr>    
                                        </thead>
                                        <tbody>
                                        </tbody>
