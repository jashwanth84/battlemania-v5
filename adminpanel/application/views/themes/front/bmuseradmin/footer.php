<script src="<?php echo $this->default_js; ?>jquery.min.js" ></script>
<script src="<?php echo $this->default_js; ?>bootstrap.bundle.min.js" ></script>
<script src="<?php echo $this->default_js; ?>jquery-3.3.1.js" ></script>
<script src="<?php echo $this->default_js; ?>jquery.dataTables.min.js" ></script>
<script src="<?php echo $this->default_js; ?>dataTables.bootstrap4.min.js" ></script>
<script src="<?php echo $this->default_js; ?>jquery.validate.js"></script> 
<script src="<?php echo $this->default_js; ?>toastr.min.js" type="text/javascript"></script>
