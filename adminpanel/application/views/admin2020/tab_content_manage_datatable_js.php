    ...
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                buttons: [
                    {
                        ...
                        title:'',                      
                        exportOptions: {
                            columns: ['thead th:not(:first-child,:last-child,:nth-last-child(3))']
                        }
                    },
                    {
                        extend: 'csv',                                                              
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>tab_content/setDatatableTabContent', // json datasource
                    type: "post",         
                    error: function () {  
                        $("#manage_tbl").html("");
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>tab_content/multi_action', // json datasource                    
                        type: 'post',
