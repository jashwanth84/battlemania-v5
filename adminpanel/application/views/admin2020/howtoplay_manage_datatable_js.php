<script type="text/javascript">
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>how_to_play/setDatatableHTPContent', // json datasource
    ...
    function confirmDeletehtpcontent(frm, htpc_id)
    {
        with (frm)
        {
            Swal.fire({
    ...
    function changePublishStatus(frm, htpc_id, status)
    {
        with (frm)
        {
            Swal.fire({
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>how_to_play/multi_action', // json datasource                    
                        type: 'post',
