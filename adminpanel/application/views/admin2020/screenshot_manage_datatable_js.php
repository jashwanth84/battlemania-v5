    ...
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>screenshots/setDatatableScreenshots', // json datasource
                    type: "post",                   
                    error: function () {  
                        $("#manage_tbl").html("");
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>screenshots/multi_action', // json datasource                    
                        type: 'post',
