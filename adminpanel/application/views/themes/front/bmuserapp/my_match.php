                                                    ...
                                                    if (!empty($ongoing_match_data)) {
                                                        foreach ($ongoing_match_data as $ongoing_match) {
                                                            if (isset($ongoing_match->image_name) && $ongoing_match->image_name != "") {
                                                                ...
                                                                $ongoing_match_img = base_url() . $this->game_image . 'thumb/1000x500_' . $ongoing_match->game_image;
                                                            }
                                                            ?>
                                                            <div class="card br-5 hide-over mb-3">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <!-- <a href="#" class="btn btn-sm btn-green ml-1"><?php echo $ongoing_match->version ?></a> -->
                                                                    <a href="#" class="btn btn-sm btn-primary ml-1"><?php echo $ongoing_match->MAP ?></a>
                                                                    <h6 class="card-title mt-2"><i class="fa fa-bomb"></i><a href="#" class="text-dark"><?php echo $ongoing_match->match_name . ' - Match #' . $ongoing_match->m_id; ?></a></h6>
                                                                    <?php if ($ongoing_match->room_description) {
                                                                        ?>
                                                                        <a href="<?php echo base_url() . $this->path_to_default . 'play/match_detail/' . $ongoing_match->m_id; ?>" class="row btn-green text-white px-3">Click here for id and password</a>
                                                                    <?php } ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($ongoing_match->prize_description != '') { ?>
                                                                                        ...
                                                                                        <a href="#" data-id="<?php echo $ongoing_match->prize_description; ?>" class="prize_modal pt-2 btn-block bm_text_lightgreen align-middle"><?php echo $this->lang->line('text_prize_pool'); ?> <br/><?php echo $ongoing_match->win_prize . '(%)'; ?><i class="fa fa-angle-down bm_text_lightgreen"></i></a>
                                                                                    <?php } else { ?>
                                                                    ...
                                                                    <a href="<?php echo $ongoing_match->match_url; ?>" target="_blank" class="btn btn-sm btn-block btn-lightpink"> <i style="" class="text-white"><?php echo $this->functions->getPoint(); ?></i> <?php echo $ongoing_match->entry_fee . ' ' . $this->lang->line('text_Spactate'); ?>  </a>
                                                                </div>
                                                            </div>         
                                                            <?php
                                                        }
                                                    ...
                                                    if (!empty($upcoming_match_data)) {
                                                        foreach ($upcoming_match_data as $upcoming_match) {
                                                            if (isset($upcoming_match->image_name) && $upcoming_match->image_name != "") {
                                                                ...
                                                                $upcoming_match_img = base_url() . $this->game_image . 'thumb/1000x500_' . $upcoming_match->game_image;
                                                            }
                                                            ?>
                                                            <div class="card br-5 hide-over mb-3">                                                                
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <!-- <a href="#" class="btn btn-sm btn-green ml-1"><?php echo $upcoming_match->version ?></a> -->
                                                                    ...
                                                                    <?php if ($upcoming_match->room_description) {
                                                                        ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($upcoming_match->prize_description != '') { ?>
                                                                                        ...
                                                                                        <a href="#" data-id="<?php echo $upcoming_match->prize_description; ?>" class="prize_modal pt-2 btn-block bm_text_lightgreen align-middle text-uppercase"><?php echo $this->lang->line('text_prize_pool'); ?> <br/><?php echo $upcoming_match->win_prize . '(%)'; ?><i class="fa fa-angle-down bm_text_lightgreen"></i></a>
                                                                                    <?php } else { ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-8">
                                                                            ...
                                                                            ?>
                                                                            <span class="text-primary"><?php echo $upcoming_match->no_of_player . "/" . $upcoming_match->number_of_position; ?></span>
                                                    ...
                                                    if (!empty($result_match_data)) {
                                                        foreach ($result_match_data as $result_match) {
                                                            if (isset($result_match->image_name) && $result_match->image_name != "") {
                                                                ...
                                                                $result_match_img = base_url() . $this->game_image . 'thumb/1000x500_' . $result_match->game_image;
                                                            }
                                                            ?>
                                                            <div class="card br-5 hide-over mb-3">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <!-- <a href="#" class="btn btn-sm btn-green ml-1"><?php echo $result_match->version ?></a> -->
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php } else { ?>
                                                                                        <span class="bm_text_lightgreen text-uppercase"><?php echo $this->lang->line('text_prize_pool'); ?> <br/><?php echo $result_match->win_prize . '(%)'; ?></span>
                                                                                    <?php } ?>
                                                                                </td>
                                                                                <td>
