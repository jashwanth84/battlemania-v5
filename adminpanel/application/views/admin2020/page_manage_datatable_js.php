    ...
    var TableDatatablesManaged = function () {
        ...
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>page/setDatatablePage', // json datasource
...
<script>
    function confirmDelete(frm, page_id)
    {
        with (frm)
        {
            Swal.fire({
    ...
    function changePublishStatus(frm, page_id, status)
    {
        with (frm)
        {
            Swal.fire({
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>page/multi_action', // json datasource                    
                        type: 'post',
