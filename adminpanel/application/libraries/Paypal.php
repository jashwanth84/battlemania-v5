...
class Paypal {
    ...
    function __construct() {
        ...
        $this->obj->db->where('payment_name', 'PayPal');
        $query = $this->obj->db->get('pg_detail', 1);
        $payment = $query->row_array();
        $this->paypal_url = ($payment['payment_status'] == 'Sandbox') ? 'https://www.sandbox.paypal.com/cgi-bin/webscr' : 'https://www.paypal.com/cgi-bin/webscr';
...
//        $this->add_field('currency_code', $this->obj->functions->getCurrencyCode($this->obj->system->currency));
