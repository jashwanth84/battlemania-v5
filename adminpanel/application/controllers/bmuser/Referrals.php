...
class Referrals extends CI_Controller {
    ...
    function index() {
        $data['my_referrals'] = true;
        $data['title'] = $this->lang->line('text_my_referrals');
        $data['breadcrumb_title'] = $this->lang->line('text_my_referrals');
        $data['tot_referral'] = $this->account->getTotalReferral($this->member->front_member_id);
        $data['tot_earnings'] = $this->account->getTotalEarnings();
        $data['my_referrals'] = $this->account->getReferrals();
        $this->load->view($this->path_to_view_default . 'my_referrals', $data);
    }
