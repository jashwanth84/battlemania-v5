<script type="text/javascript">
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>announcement/setDatatableAnnouncement', // json datasource
    ...
    function confirmDelete(frm, announcement_id)
    {
        with (frm)
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    frm.announcementid.value = announcement_id;
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>announcement/multi_action', // json datasource                    
                        type: 'post',
