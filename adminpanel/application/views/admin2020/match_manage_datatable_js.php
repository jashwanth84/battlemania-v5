    ...
    var TableDatatablesManaged = function () {
        var initTable1 = function () {
            ...
            table.DataTable({
                ...
                buttons: [
                    {
                        ...
                        title:'',                                              
                        exportOptions: {
                            columns: ['thead th:not(:first-child,:last-child,:nth-last-child(2))'],                          
                            format: {
                ...
                "ajax": {
                    url: '<?php echo base_url() . $this->path_to_view_admin ?>matches/setDatatableMatch', // json datasource
        ...
        if(ids_arr.length > 0){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() . $this->path_to_view_admin ?>matches/multi_action', // json datasource                    
                        type: 'post',
